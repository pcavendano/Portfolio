...
import robot from "../assets/hero_test.png";
   ...
   const onButtonClick = () => {
    ...
    return (
        <section className="home_hero">
            <figure>
                <img src={robot} alt="photo de profil"></img>
            </figure>
            <div className="content">
                <h1>
                    ...
                    Web Developer
                    <br />
                    <span className="open">consecte</span>
                    to adipiscingin
                </h1>
                <p>
                    Professional web developper building interactive web
                    products - ready to commit, learn, adapt and improve.
                    <br />I develop digital products from scratch.
                </p>
                 <div className="links">
                  <ul>
                    <li>
                ...
                <div className="btn-container">
                  <a className="btn" onClick={onButtonClick}>Download PDF</a>
                </div>
            </div>
        </section>
    );
